...
import com.yjxxt.crm.utlis.Md5Util;
import com.yjxxt.crm.utlis.PhoneUtil;
import com.yjxxt.crm.utlis.UserIDBase64;
...
public class UserService extends BaseService<User,Integer> {
    ...
    private void checkPasswordParams(User user, String oldPassword, String newPassword, String confirmPwd) {
        ...
        //新密码非空
        AssertUtil.isTrue(StringUtils.isBlank(newPassword),"用户未登录或不存在");
        //新密码和原始密码不能一致
        AssertUtil.isTrue(newPassword.equals(oldPassword),"新密码不能和原始密码一致");
        //确认密码非空
        AssertUtil.isTrue(StringUtils.isBlank(newPassword),"确认密码不能为空");
        //确认密码与新密码一致
        AssertUtil.isTrue(!confirmPwd.equals(newPassword),"确认密码要与新密码一致");
    }
